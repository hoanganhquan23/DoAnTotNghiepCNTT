          ...
          <div className="main-wrapper w-full lg:flex lg:space-x-[30px]">
            <div className="lg:w-1/2 w-full">
              ...
              <p className="text-[15px] text-qgraytwo leading-[30px] mb-5">
                Điền vào mẫu dưới đây hoặc viết cho chúng tôi. Chúng tôi sẽ hỗ
                trợ bạn sớm nhất có thể.
              </p>
              ...
              <div className="xl:flex xl:space-x-[30px] mb-[30px]">
                ...
                <div className="xl:w-1/2 w-full h-[196px] flex flex-col justify-center bg-[#D3EFFF] p-5">
                  ...
                  <p className="text-[15px] text-black leading-[30px] text-center">
                    Migaosach98gmail.com
                  </p>
                  {/* <p className="text-[15px] text-black leading-[30px] text-center">
                    quynhnguyen03062002@gmail.com
                  </p> */}
                </div>
              </div>
              <div className="p-5 flex flex-col justify-between w-full bg-[#E7F2EC]">
                <div className="flex space-x-5">
                  ...
                  <div>
                    ...
                    <p className="text-[15px] text-qblack leading-[30px]">
                      TDP Hà Thanh, Phường Thanh Hải,  Thị Xã Chũ, Tỉnh Bắc Giang
                    </p>
                  </div>
                </div>
                ...
                <div className="w-full h-[206px] mt-5">
                  <iframe
                    title="addressMap"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29719.991812077653!2d106.55170411267912!3d21.389944952220727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314aa1f0076df6a5%3A0xc5bbc93c6520a1cb!2zSMOgIHRoYW5o!5e0!3m2!1svi!2s!4v1746807328685!5m2!1svi!2s"
            ...
            <div className="flex-1 bg-white sm:p-10 p-3">
              ...
              <div className="inputs mt-5">
                ...
                <div className="mb-4">
                  <InputCom
                    label="Địa chỉ Email*"
                    placeholder="Migaosach98gmail.com"
                    name="email"
                    inputClasses="h-[50px]"
                  />
                </div>
                <div className="mb-4">
                  <InputCom
                    label="Chủ đề*"
                    placeholder="Nhập chủ đề tại đây"
                    name="subject"
                    inputClasses="h-[50px]"
                  />
                </div>
